...
pax_mcap_pd.to_csv('pax_mcap.csv',sep=',',index=False)
...
usdc_mcap_pd.to_csv('usdc_mcap.csv',sep=',',index=False)
...
dai_mcap_pd.to_csv('dai_mcap.csv',sep=',',index=False)
...
total_mcap_pd.to_csv('total_mcap.csv',sep=',',index=False)
...
dominance_pd.to_csv('tether_dominance.csv',sep=',',index=False)